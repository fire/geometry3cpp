...
bool g3::PackedMesh::HasPositions() const { return !m_vPositions.empty(); }
...
void g3::PackedMesh::CopyVertices(const std::vector<float> &vPositions,
...
void g3::PackedMesh::CopyVertices(const float *pPositions, size_t nVertices,
...
void g3::PackedMesh::CopyTriangles(const unsigned int *pIndices,
                                   size_t nTriangles,
...
void g3::PackedMesh::CopyTriangles(const int *pIndices, size_t nTriangles,
                                   const int *pGroups) {
...
void PackedMesh::GetTriangle(unsigned int k, g3::Vector3f &v0, g3::Vector3f &v1,
                             g3::Vector3f &v2) const {
...
g3::Vector3f PackedMesh::GetTriangleNormal(unsigned int k) const {
  unsigned int i0, i1, i2;
  GetTriangle(k, i0, i1, i2);
  return g3::Normal(g3::Vector3f(GetPosition(i0)),
                    g3::Vector3f(GetPosition(i1)),
                    g3::Vector3f(GetPosition(i2)));
}
